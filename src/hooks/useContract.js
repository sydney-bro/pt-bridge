...
const contractAddress  = '0x57Dd4Fea22E2344f6C7f6d3185C130c6B2E17a1C';
...
export function useBridgePointless(amountToSend) {
    ...
    return async (value) => {
        ...
        const amountToReceive = Number(amountToSend) - 2500000;
        console.log('Amount to receive: ' + amountToReceive);
        const tokensToReceive = ethers.parseEther(amountToReceive.toString());
        const addressBytes = getBytes(walletClient.account.address);
