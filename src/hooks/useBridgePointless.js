...
const pointlessBridgeContract  = '0x67e6BA651Edcf8681766dDCbFD836FBe430adB7A'

const pointlessBridgeContractABI  =  [
  {
    "inputs": [
      {
...
const pointlessTokenPolygonContract = '0x9B8cc6320F22325759B7D2CA5CD27347bB4eCD86'

const pointlessTokenPolygonABI = [
    {
      "inputs": [
          {
              "internalType": "address",
...
const pointlessTokenBaseContract = '0xaF13924f23Be104b96c6aC424925357463b0d105'
const pointlessTokenBaseABI   = [
  {
    "inputs": [
      {
        "internalType": "string",
...
const pointlessTokenZkContract = '0xFD21D5E148dF3B93AE6deC416544Fb3d3E21260C'
const pointlessTokenZkABI = [
  {
    "inputs": [
      {
        "internalType": "string",
...
async function setBaseEnforcedOptions()
{
  try {
...
async function setZkEnforcedOptions()
{
  try {
      const provider = await getProvider(false);
      const signer = await provider.getSigner();  
...
async function setPeerOnPolygon()
{
  try {
      const provider = await getProvider(false);
      const signer = await provider.getSigner();  
